...
$row11=mysqli_fetch_row($res21);
 ...
 $sq1="SELECT  SUM(rent),sum(qty),sum(return_qty),sum(discount),SUM(CAST(REPLACE(commission_amt, ',', '') AS DECIMAL(10,2)) * qty)
 FROM  `order_detail` WHERE `item_id` ='$row[0]' and bill_id in (SELECT bill_id FROM `phppos_rent` WHERE `booking_status`='Picked' or booking_status='' or booking_status='Returned')";
...
<td width="74"> <?php echo number_format($row[5],0); ?></td>
<td width="74"> <?php echo number_format($tcost,0); ?></td>
<td width="87"><?php echo number_format($row[6],0); ?></td>
<td width="74"> <?php echo number_format($tmrp,0); ?></td>
...
<td width='58'><?php echo $rentqty; 
$sumap2 = (float)$sumap2 + (float)$rentqty;?></td>
...
<td align="left"><?php echo  number_format($tbal,0); ?></td>
<td align="left" width="113"><?php echo $a4;	$sold = (float)$sold + (float)$a4; ?></td>
<td align="left" width="127"><?php echo  $a1;$approval = (float)$approval + (float)$a1; ?></td>
<td align="left"><?php echo number_format($row4[4],0); ?></td>
<td align="left"><?php echo number_format($ttl1,0); ?></td>
</tr>
...
// 			$showthisQty
            ...
            <td><?php echo number_format($tcostsum,0); ?></td>
            <td><?php echo number_format($sum1,0); ?></td>
            <td><?php echo number_format($tmrpsum,0); ?></td>
            ...
            <td><?php echo $missqty_sum; ?></td>
             <td><?php echo number_format($balsum,0); ?></td>
            <td><?php echo $sold; ?></td>
            <td><?php echo  $approval; ?></td>
            <td><?php echo number_format($sum4,0); ?></td>
            <td><?php echo number_format($sum5,0); ?></td>
            </tr>
</table> 
<?php CloseCon($con);?>