                                ...
                                for ($i = 0; $i < $d; $i++) {
                                    ...
                                    if ($company_name == 'SAKAR TRADE LINK') {
                                        ...
                                        if ($beautician_discount > 0) {
                                            ...
                                            if ($productType == 2) {
                                                // 18% gst
                                                $beautician_discountAmount_amount = $beautician_discountAmount*0.18;
                                                $beautician_discountAmount = $beautician_discountAmount - $beautician_discountAmount;
                                                
                                            }else{
                                                // 3% gst 
                                                $beautician_discountAmount_amount = $beautician_discountAmount*0.03;
                                                $beautician_discountAmount = $beautician_discountAmount - $beautician_discountAmount;
