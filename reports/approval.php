...
return false;
   ...
   var form = document.getElementById("frm1");
        var company = document.forms["listForm"]["company_name"].value;

        if (company === "SAKAR TRADE LINK") {
            form.action = "sakar_sell.php";
        } else if (company === "Sri Shringarr") {
            form.action = "ssfs_sell.php";
        } else {
...
<form name="listForm" method="POST" id="frm1">
...
<table width="863">
        ...
        <td>Company Name</td>
          ...
          <select name="company_name" required>
              ...
              <option value="Sri Shringarr" selected>Sri Shringarr</option>
              <option value="SAKAR TRADE LINK" >SAKAR TRADE LINK</option>
          </select>
        </td>
<tr>
...
<td width="225">
    ...
    <tr>
        ...
        <td>Bill prepare by</td>
          <td colspan="2"> 
          <select name="bill_prepare_by" required>
              <option>Select</option>
    ...
    <td width='203'>Total Qty : <input type="text" name="qty11" id="qty11"  value="" style="width:100px;" readonly/></td>
     ...
     <input type="hidden" name="cardpercamt" id="cardpercamt"  value="" style="width:100px;" readonly/>
      ...
      <td width="340" align="center">
          Payment By : 
<br>
        <input name="pay_By" type="radio" value="Bank" onchange="Totalamount()"> &nbsp; Bank 
       <br>          
        <input name="pay_By" type="radio" value="Cash" onchange="Totalamount()"> &nbsp; Cash
        <br>
