...
<nav class="sidebar sidebar-offcanvas bt" id="sidebar">
            ...
            foreach ($mainmenu as $menu => $menu_id) {
                ...
                <li class="nav-item ">
                    <a class="nav-link" data-toggle="collapse" href="#<?php echo $targetDiv; ?>" aria-expanded="false"
                        aria-controls="<?php echo  $targetDiv; ?>">
                            ...
                            } else if ($main_name == 'Bank' || $main_name == 'Masteradmin') {
                            ...
                            else if ($main_name == 'Measurements' || $main_name == 'Videos') {
                                echo '<i class="fas fa-shopping-basket menu-icon" style="color: #FFB64D;"></i>';
                            }
                    ...
                    <div class="collapse" id="<?php echo  $targetDiv; ?>">
                        <ul class="nav flex-column sub-menu">
                            ...
                            while ($submenu_sql_result = mysqli_fetch_assoc($submenu_sql)) {
                                ...
                                $title = $submenu_sql_result['title'];
